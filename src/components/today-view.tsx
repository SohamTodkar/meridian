...
export function TodayView() {
  ...
  return (
    <div className="content">
      {/* Hero Banner with Kinetic Typography and 3D WebGL Astrolabe */}
      ...
      <section className="action-panel" aria-labelledby="next-action">
      ...
      <section className="action-panel plan-panel" aria-labelledby="daily-plan-heading">
      ...
      <section className="section" aria-labelledby="log-heading" id="daily-capture">
